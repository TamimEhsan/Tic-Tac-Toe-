...
public class Main extends Application {
    ...
    private Image linev;
    private Image lineh;
    private Image linec1;
    private Image linec2;
    ...
    public void init() {
       ...
       // ctx.setFill(Color.BLACK);
        board = new Image(getClass().getResourceAsStream("ttt2.png"),0,0,true,false);
        circle = new Image(getClass().getResourceAsStream("circle.png"),0,0,true,false);
        cross = new Image(getClass().getResourceAsStream("cross.png"),0,0,true,false);
        linev = new Image(getClass().getResourceAsStream("linevertical.png"),0,0,true,false);
        lineh = new Image(getClass().getResourceAsStream("linehorizontal.png"),0,0,true,false);
        linec1 = new Image(getClass().getResourceAsStream("linecross1.png"),0,0,true,false);
        linec2 = new Image(getClass().getResourceAsStream("linecross2.png"),0,0,true,false);
    ...
    private void check(){
        ...
        if( winner!=0 ){
            running = false;
            if( winner == 1 ) Dialogcontroller("Congratulations! You win");
    ...
    private void Dialogcontroller(final String message) {
        ...
        dialog.setTitle("Game Over screen for Server");
        dialog.getDialogPane().setContentText(message+".... Would you like to start a new game,Sir?  ");
